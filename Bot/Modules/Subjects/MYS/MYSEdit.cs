...
{
    public class MYSEdit : SP1XModuleBase
    {
        public MYSEdit(IServiceProvider serviceProvider, IConfiguration configuration) : base(serviceProvider, configuration)
        {
        }

        [Command("mysedit", RunMode = RunMode.Async)]
